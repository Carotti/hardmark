...
create_clock -period 6.734 -waveform {0 3.367} [get_ports { hdmi_rx_clk_p }];
...
#set_property -dict { PACKAGE_PIN B13   IOSTANDARD LVCMOS33 } [get_ports { hdmi_tx_scl }]; #IO_L11P_T1_SRCC_34 Sch=hdmi_rx_scl
#set_property -dict { PACKAGE_PIN B9   IOSTANDARD LVCMOS33 } [get_ports { hdmi_tx_sda }]; #IO_L11N_T1_SRCC_34 Sch=hdmi_rx_sda
