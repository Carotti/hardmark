...
module design_1_scene_wrapper_0_0(pixel_clk, hsync, vsync, sphere_x, sphere_y, 
  sphere_z, sphere_radius, pixel_data, hcount, vcount)
/* synthesis syn_black_box black_box_pad_pin="pixel_clk,hsync,vsync,sphere_x[23:0],sphere_y[23:0],sphere_z[23:0],sphere_radius[23:0],pixel_data[31:0],hcount[10:0],vcount[10:0]" */;
  input pixel_clk;
  input hsync;
  input vsync;
  input [23:0]sphere_x;
