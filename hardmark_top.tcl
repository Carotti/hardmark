...
################################################################
# This is a generated script based on design: hardmark_top
#
...
# source hardmark_top_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# alpha_combine, scene_wrapper, xvga
...
nippy.org:nippy:render_register:1.0\
...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.CLKOUT1_JITTER {191.449} \
   CONFIG.CLKOUT1_PHASE_ERROR {284.610} \
   CONFIG.CLKOUT1_REQUESTED_OUT_FREQ {119} \
   CONFIG.CLKOUT2_JITTER {178.755} \
   CONFIG.CLKOUT2_PHASE_ERROR {284.610} \
   CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {200.000} \
   CONFIG.CLKOUT2_USED {true} \
   CONFIG.CLK_IN1_BOARD_INTERFACE {sys_clock} \
   CONFIG.MMCM_CLKFBOUT_MULT_F {57.125} \
  ...
  set block_name xvga
  set block_cell_name xvga_0
  if { [catch {set xvga_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $xvga_0 eq "" } {
     catch {common::send_msg_id "BD_TCL-106" "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
    ...
    set_property -dict [ list \
   CONFIG.hBackPorch {80} \
   CONFIG.hFrontPorch {48} \
   CONFIG.hSyncWidth {32} \
   CONFIG.hWidth {1680} \
   CONFIG.vBackPorch {21} \
   CONFIG.vFrontPorch {3} \
   CONFIG.vSyncWidth {6} \
   CONFIG.vWidth {1050} \
 ] $xvga_0
  ...
  connect_bd_net -net clk_wiz_0_clk_out2 [get_bd_pins clk_wiz_0/clk_out2] [get_bd_pins dvi2rgb_0/RefClk]
  connect_bd_net -net dvi2rgb_0_vid_pData [get_bd_pins alpha_combine_0/rgb_in] [get_bd_pins dvi2rgb_0/vid_pData]
  ...
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins render_register_0/s00_axi_aclk] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  ...
  connect_bd_net -net render_register_0_sphere_x [get_bd_pins render_register_0/sphere_x] [get_bd_pins scene_wrapper_0/sphere_x] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net reset_rtl_1 [get_bd_pins clk_wiz_0/reset] [get_bd_pins dvi2rgb_0/aRst] [get_bd_pins dvi2rgb_0/pRst] [get_bd_pins rgb2dvi_0/aRst] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  connect_bd_net -net rst_ps7_0_100M_peripheral_aresetn [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins render_register_0/s00_axi_aresetn] [get_bd_pins rst_ps7_0_100M/peripheral_aresetn]
  ...
  connect_bd_net -net xlslice_1_Dout [get_bd_ports leds_4bits_tri_o] [get_bd_pins xlslice_1/Dout]
