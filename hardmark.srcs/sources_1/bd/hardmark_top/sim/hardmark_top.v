...
(* CORE_GENERATION_INFO = "hardmark_top,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=hardmark_top,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=18,numReposBlks=18,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=1,da_board_cnt=1,da_bram_cntlr_cnt=2,da_ps7_cnt=1,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "hardmark_top.hwdef" *) 
module hardmark_top
   (DDR_addr,
    DDR_ba,
    DDR_cas_n,
  ...
  (* BMM_INFO_ADDRESS_SPACE = "byte  0x40000000 32 > hardmark_top axi_bram_ctrl_0_bram" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  hardmark_top_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  hardmark_top_axi_bram_ctrl_0_bram_0 axi_bram_ctrl_0_bram
       (.addra({1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,1'b0,axi_bram_ctrl_0_BRAM_PORTA_ADDR}),
        .addrb(xlconcat_1_dout),
        ...
        .enb(xlconstant_2_dout),
        .rsta(axi_bram_ctrl_0_BRAM_PORTA_RST),
        .rstb(1'b0),
        .wea(axi_bram_ctrl_0_BRAM_PORTA_WE),
        .web(xlconstant_1_dout));
  hardmark_top_axi_smc_0 axi_smc
  ...
  hardmark_top_clk_wiz_0_0 clk_wiz_0
       (.clk_in1(sys_clock_1),
        ...
        .reset(reset_rtl_1));
  (* BMM_INFO_PROCESSOR = "arm > hardmark_top axi_bram_ctrl_0" *) 
  (* KEEP_HIERARCHY = "yes" *) 
  hardmark_top_processing_system7_0_0 processing_system7_0
  ...
  hardmark_top_rst_ps7_0_100M_0 rst_ps7_0_100M
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  hardmark_top_xlconcat_0_0 xlconcat_0
       (.In0(xlconcat_2_dout),
        .In1(xvga_0_vcount),
        .dout(xlconcat_0_dout));
  hardmark_top_xlconcat_1_0 xlconcat_1
       (.In0(xlconcat_0_dout),
        .In1(xlconstant_3_dout),
        .dout(xlconcat_1_dout));
  hardmark_top_xlconcat_2_0 xlconcat_2
       (.In0(xlconstant_4_dout),
        .In1(xvga_0_hcount),
        .dout(xlconcat_2_dout));
  hardmark_top_xlconstant_0_0 xlconstant_0
       (.dout(reset_rtl_1));
  hardmark_top_xlconstant_1_0 xlconstant_1
       (.dout(xlconstant_1_dout));
  hardmark_top_xlconstant_2_0 xlconstant_2
       (.dout(xlconstant_2_dout));
  hardmark_top_xlconstant_3_0 xlconstant_3
       (.dout(xlconstant_3_dout));
  hardmark_top_xlconstant_4_0 xlconstant_4
       (.dout(xlconstant_4_dout));
  hardmark_top_xlslice_0_0 xlslice_0
       (.Din(axi_bram_ctrl_0_bram_doutb),
        .Dout(xlslice_0_Dout));
