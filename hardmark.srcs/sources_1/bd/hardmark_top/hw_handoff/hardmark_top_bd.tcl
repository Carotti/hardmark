...
proc create_root_design { parentCell } {
  ...
  connect_bd_net -net axi_bram_ctrl_0_bram_doutb [get_bd_pins axi_bram_ctrl_0_bram/doutb] [get_bd_pins xlslice_0/Din]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_bram_ctrl_0_bram/clkb] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins rgb2dvi_0/PixelClk] [get_bd_pins xvga_0/vclock]
  ...
  connect_bd_net -net xlconcat_1_dout [get_bd_pins axi_bram_ctrl_0_bram/addrb] [get_bd_pins xlconcat_1/dout]
  connect_bd_net -net xlconcat_2_dout [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_2/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_bram_ctrl_0_bram/web] [get_bd_pins xlconstant_1/dout]
  ...
  connect_bd_net -net xlconstant_4_dout [get_bd_pins xlconcat_2/In0] [get_bd_pins xlconstant_4/dout]
  ...
  connect_bd_net -net xvga_0_hcount [get_bd_pins xlconcat_2/In1] [get_bd_pins xvga_0/hcount]
  connect_bd_net -net xvga_0_hsync [get_bd_pins rgb2dvi_0/vid_pHSync] [get_bd_pins xvga_0/hsync]
  connect_bd_net -net xvga_0_vcount [get_bd_pins xlconcat_0/In1] [get_bd_pins xvga_0/vcount]
