...
module xvga(vclock, hcount, vcount, vsync, hsync, blank);
    ...
    reg [$clog2(pipelineLatency) - 1:0] pipelineCount;
    
    initial hcount = 0;
    initial vcount = 0;
    initial pipelineCount = 0;
    
    wire pipelineFull;
    
    assign pipelineFull = (pipelineCount == pipelineLatency);
